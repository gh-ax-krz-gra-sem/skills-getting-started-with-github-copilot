...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:3000", "http://localhost:5173"],  # React dev servers (CRA and Vite)
...
activities = {
    ...
    "Drama Club": {
        "description": "Perform in plays and learn acting, stagecraft, and theatrical production",
    ...
    "Science Olympiad": {
        "description": "Participate in science competitions covering biology, chemistry, physics, and engineering",
...
@app.post("/api/activities/{activity_name}/signup")
...
@app.delete("/api/activities/{activity_name}/unregister")
